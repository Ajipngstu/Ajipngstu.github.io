...
include "..\koneksi.php";
	if(isset($_GET['id_adrenaline'])) {
		...
		$query=$dbh->query(" SELECT * FROM tb_adrenaline WHERE id_adrenaline='$_GET[id_adrenaline]'");
		$data=$query->fetch(PDO::FETCH_ASSOC);
	}
    if(isset($_GET['id_adrenaline'])) {
		$query=$dbh->query("SELECT * FROM tb_adrenaline a JOIN tb_data b ON a.id_data = b.id_data ");
		$data=$query->fetch(PDO::FETCH_ASSOC);
	}
?>
...
<?php
	if (isset($_POST['update'])) {
        $id_adrenaline         = $_GET['id_adrenaline']; 
        $nama               = $_POST['nama'];
		...
		$myqry="UPDATE tb_adrenaline SET nama = '$nama',
		 							 jenis_sepeda = '$jenis_sepeda',
		 							 harga = '$harga',
		 							 jumlah = '$jumlah',
		 							 tanggal = '$tanggal',
		 							 jenis_warna = '$jenis_warna'
		 							 WHERE id_adrenaline='$id_adrenaline'";

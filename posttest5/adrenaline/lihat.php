...
<body>
    ...
    <p class="info">Data Sepeda adrenaline</p>
    <table>
        <tr>
            <th>ID</th>
            <th>ID Data</th>
        ...
        $tampil = "SELECT * FROM tb_adrenaline a JOIN tb_data b ON a.id_data = b.id_data ";
        $query = $dbh->query($tampil);
        foreach ($query as $data ){
        ?>
        <tr>
            <td><?php echo $data ['id_adrenaline']?></td>
            <td><?php echo $data ['id_data']. ' | ' .$data['ns_adrenaline']?></td>
            ...
            <td colspan='2'>
                <a class="ubah"  href="ubah.php?id_adrenaline=<?php echo $data ['id_adrenaline']?>" onclick="return confirm('Ingin Mengubah Data?');" role="button">
                ...
                <a class="hapus" href="hapus.php?id_adrenaline=<?php echo $data ['id_adrenaline']?>" onclick="return confirm('Ingin Mengapus Data?');" role="button">

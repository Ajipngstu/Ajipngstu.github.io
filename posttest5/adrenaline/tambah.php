...
include '..\koneksi.php';
	...
	$tampil = "SELECT max(id_adrenaline) as maxKode FROM tb_adrenaline";
 ...
 if(isset($_POST['simpan'])){
    ...
    // Menambahkan data INTO nama_table VALUES nama fieldnya;
 	$query = "INSERT INTO tb_adrenaline VALUES ('$id_adrenaline','$id_data', '$nama', ' $jenis_sepeda',
        ...
        <td>
            <select name="id_data">
                ...
                <?php
                    ...
                    foreach($query as $data){
                ?>
                <option value="<?php echo $data['id_data'];?>"><?php echo $data['id_data'];?> | <?php echo $data['ns_adrenaline'];?></option>
                <?php } ?>
            </select>
        </td>
		</tr>
            ...
            <tr>
                <td>Jenis Sepeda</td>
                <td>
                    <input type="text" name="jenis_sepeda" value="adrenaline" readonly>
                </td>
            </tr>
            <tr>
                <td>Harga Sepeda</td>
